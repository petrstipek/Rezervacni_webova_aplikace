...
def create_application(test_config=None):
    ...
    #application.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://felixgrent:password@rds-mysql-skiressys.c9sa6ogi4a00.eu-north-1.rds.amazonaws.com/rds-mysql-skiressys'
    ...
    application.register_blueprint(reservations_bp, url_prefixes="/reservations")
    ...
    application.register_blueprint(admin_instructors_bp, url_prefix="/admin-api-instructors")
