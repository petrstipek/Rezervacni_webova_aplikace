# FileName: renew_password.py
# Description: Handles the password renewal and reset routes. Generates reset token and validates it.
# Author: Petr Štípek
# Date: 2024

from itsdangerous import URLSafeTimedSerializer, BadSignature, SignatureExpired
from flask import current_app, redirect, flash, url_for, render_template
from flaskr.email.email import send_password_reset
